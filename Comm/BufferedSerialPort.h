...
#ifndef COMM_BUFFEREDSERIALPORT_INCLUDED
#define COMM_BUFFEREDSERIALPORT_INCLUDED

#include <Comm/Pipe.h>

namespace Comm {

class BufferedSerialPort:public Comm::Pipe
	{
	/* Embedded classes: */
	public:
	enum PortSettings
	...
	public:
	BufferedSerialPort(const char* deviceName); // Opens the given serial port device file with "DontCare" endianness setting
	virtual ~BufferedSerialPort(void);
