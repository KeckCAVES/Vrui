...
class OpenVRHost:public VRDevice,public vr::IVRSettings,public vr::IVRDriverContext,public vr::IVRProperties,public vr::IVRDriverInput,public vr::IVRDriverLog,public vr::IVRServerDriverHost,public vr::IVRResources,public vr::IVRDriverManager
	...
	virtual vr::EVRInputError CreateSkeletonComponent(vr::PropertyContainerHandle_t ulContainer,const char* pchName,const char* pchSkeletonPath,const char* pchBasePosePath,const vr::VRBoneTransform_t* pGripLimitTransforms,uint32_t unGripLimitTransformCount,vr::VRInputComponentHandle_t* pHandle);
