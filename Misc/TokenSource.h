...
#ifndef MISC_TOKENSOURCE_INCLUDED
#define MISC_TOKENSOURCE_INCLUDED
...
class TokenSource
	...
	/* Elements: */
	CharacterSource& source; // Reference to character source for token reader
	...
	public:
	TokenSource(CharacterSource& sSource); // Creates a token source for the given character source
	~TokenSource(void);
