...
#ifndef MISC_CSVSOURCE_INCLUDED
#define MISC_CSVSOURCE_INCLUDED
...
class CSVSource
	...
	/* Elements: */
	private:
	CharacterSource& source; // Reference to character source for CSV source
	...
	/* Constructors and destructors: */
	public:
	CSVSource(CharacterSource& sSource); // Creates a default CSV source for the given character source
