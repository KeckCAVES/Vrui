...
#ifndef GLEXTENSIONS_GLNVTEXTURESHADER_INCLUDED
#define GLEXTENSIONS_GLNVTEXTURESHADER_INCLUDED
...
class GLNVTextureShader:public GLExtension
	{
	/* Elements: */
	private:
	...
	private:
	GLNVTextureShader(void);
	public:
	virtual ~GLNVTextureShader(void);
